...
class PostServiceTest {
	...
	void setUp() {
		...
		uploadedImageUrl = uploadResponse.result().imageUrl();
	}
	...
	void createPostWithInvalidCategoryIntegrationTest() {
		// Given
		PostCreateRequest request = new PostCreateRequest("유효한 제목", "유효한 내용", 999L, new String[]{"hashtag"}, List.of(uploadedImageUrl));
